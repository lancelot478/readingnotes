...
![](<https://static001.geekbang.org/resource/image/20/7b/207a653d62896f7977107ff314b0fc7b.jpg>)

<audio><source src="https://static001.geekbang.org/resource/audio/66/a9/6668f24a830dd8e9f9a604e0878f75a9.mp3" type="audio/mpeg"></audio>
...
3. **Lua可以是一种胶水语言。严谨地说，像Python、Ruby等脚本语言，都是合格的胶水语言。** 在这种情况下，胶水语言起到的作用就是粘合系统语言（C/C++）和上层脚本逻辑。所以，使用胶水语言，就像是一种动态的配置文件。<br>
